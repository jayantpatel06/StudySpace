...
const ProfileScreen = () => {
  ...
  const focusHours =
    typeof userInfo?.totalFocusTime === "number"
  ...
  const handleCopyStudentCode = () => {
    if (studentCode) {
      ...
      Alert.alert(
        "Copied!",
        "Your student code has been copied to clipboard. Share it with library administrators to subscribe to their libraries.",
      );
    }
  };
  ...
  const isRefreshDisabled = permissionGranted
    ? isLoading || !selectedLibrary
    : false;
    ...
    >
            ...
            <View style={styles.studentCodeContainer}>
              <View style={styles.studentCodeLeft}>
                ...
                <View>
                  <Text
                    style={[
                      styles.studentCodeLabel,
                      { color: colors.textMuted },
                    ]}
                  >
                    Share this code with library administrator
                  </Text>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.copyButton,
                  { backgroundColor: colors.primaryLight, marginLeft: 20 },
                ]}
              >
                <MaterialIcons
                  name="content-copy"
      ...
      <View style={styles.section}>
        ...
        <Text
          style={[
            styles.sectionTitle,
            { marginTop: 24, color: colors.textSecondary },
          ]}
        >
          Account
        </Text>
        <View style={[styles.card, { backgroundColor: colors.surface }]}>
          <View style={styles.menuRow}>
            ...
            <Switch
              ...
              thumbColor={
                hasNotificationPermission ? colors.primary : colors.textMuted
              }
            />
          </View>
